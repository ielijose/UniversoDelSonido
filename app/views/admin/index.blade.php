						...
						<div class="tiles-body">
							...
							<div class="notification-messages info">
								<div class="user-profile">
									<img src="/admin/assets/img/profiles/c.jpg" data-src="/admin/assets/img/profiles/c.jpg" data-src-retina="assets/img/profiles/c2x.jpg" width="35" height="35">
								</div>
							...
							<div class="notification-messages success">
								<div class="user-profile">
									<img src="/admin/assets/img/profiles/h.jpg" data-src="/admin/assets/img/profiles/h.jpg" data-src-retina="assets/img/profiles/h2x.jpg" width="35" height="35">
								</div>
								<div class="message-wrapper">
									<div class="heading">
							...
							<div class="row">
								<div class="user-comment-wrapper col-mid-12">
									<div class="profile-wrapper">
										<img src="/admin/assets/img/profiles/d.jpg" data-src="/admin/assets/img/profiles/d.jpg" data-src-retina="assets/img/profiles/d2x.jpg" width="35" height="35">
									</div>
									<div class="comment">
										<div class="user-name">
